...
public class ProductDto {
    ...
    public void setColorOptions(List<ProductDto> colorDtoList) {
        colorOptions = new ArrayList<>();
        for (ProductDto colorDto : colorDtoList) {
    ...
    public void setSizeOptions(List<ProductDto> sizeDtoList) {
        sizeOptions = new ArrayList<>();
        for (ProductDto sizeDto : sizeDtoList) {
