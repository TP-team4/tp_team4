...
/* 값확인을 위한 임시 */
	public ProductDto ProductView(HashMap<String, String> param);//상품상세보기
	public List<ProductDto> productColor(HashMap<String, String> param);//상품옵션 색상
	public List<ProductDto> productSize(HashMap<String, String> param);//상품옵션 색상
}
