						...
						<main class="form-signin w-100 m-auto">
							...
							<table align="center" width="600px">
								<form method="post" action="registerOk" name="signform" id="signform" onsubmit="return mySubmit()">
									...
									<tr height="50px">
										<td colspan="2"><input type="text" size="20" name="id"
											id="id"></td>
									</tr>
									<tr>
									...
									<tr height="50px">
										<td colspan="2"><input type="password" size="20"
											name="re_pwd" id="re_pwd"></td>
									</tr>
									<tr>
										<td colspan="2" style="text-align: left;"><span
											id="alert-success">비밀번호가 일치합니다.</span> <span
								...
								<tr height="50px">
									<td colspan="2"><input type="text" size="20" name="email"
										id="email">
								</tr>
								<tr>
									<td colspan="2" style="text-align: left;">
