									...
									<table class="table table-striped" >
										...
										<tbody>
											<c:forEach var="dto" items="${orderListPaging}">
												<tr>
													<td><a href="order_view?ordercode=${dto.ordercode}" style="color:#508FED;">${dto.ordercode}</a></td>
													<td>${dto.userid}</td>
													<td>${dto.orderdate}</td>
...
<!-- 						관리자 로그인 한 상태 -->
							<li>${admindto.id}님</li>
							<li><a href="http://localhost:8181/hyo_ShoppingMall/mainPage">Log out</a></li>
